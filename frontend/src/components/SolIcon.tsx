...
export function SolIcon({ size = 16 }: SolIconProps) {
  const id = useId();
  const gradientId = `sol-grad-${id}`;

  return (
    <svg width={size} height={size} viewBox="0 0 397.7 311.7" xmlns="http://www.w3.org/2000/svg" aria-label="SOL">
      <defs>
        <linearGradient
          id={gradientId}
          x1="360.879" y1="351.455" x2="141.213" y2="-69.294"
